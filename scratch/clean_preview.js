...
$leftoverOld = @($destPrev.Items() | Where-Object { $_.Name -like "_old_*" })
Write-Output "Found $($leftoverOld.Count) old preview files to clean up..."
...
Write-Output "Preview items after cleanup:"
